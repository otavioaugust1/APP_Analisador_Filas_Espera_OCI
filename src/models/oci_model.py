...
class OCIModel:
        ...
        self.agrupamentos = {
            ...
            '0901010057': {
                ...
                'itens_obrigatorios': [
                    {
                        'codigo': '0201010666',
                        'descricao': 'BIOPSIA DO COLO UTERINO',
                    },
                    {
                        'codigo': '0203020081',
            ...
            '0901010081': {
                ...
                'itens_obrigatorios': [
                    {
                        'codigo': '0209010029',
                        'descricao': 'COLONOSCOPIA (COLOSCOPIA)',
                    },
                    {
                        'codigo': '0301010072',
                        'descricao': 'CONSULTA MEDICA EM ATENÇÃO ESPECIALIZADA',
            ...
            '0902010018': {
                ...
                'itens_facultativos': [
                    {
                        'codigo': '0202010279',
                        'descricao': 'DOSAGEM DE COLESTEROL HDL',
                    },
                    {
                        'codigo': '0202010287',
                        'descricao': 'DOSAGEM DE COLESTEROL LDL',
                    },
                    {
                        'codigo': '0202010295',
                    ...
                    {
                        'codigo': '0202010317',
                        'descricao': 'DOSAGEM DE CREATININA',
                    },
                    {
                        'codigo': '0202010473',
                        'descricao': 'DOSAGEM DE GLICOSE',
                    },
                    {
                        'codigo': '0202010503',
                    ...
                    {
                        'codigo': '0202010678',
                        'descricao': 'DOSAGEM DE TRIGLICERIDEOS',
                    },
            ...
            '0903010011': {
                ...
                'itens_facultativos': [
                    ...
                    {
                        'codigo': '0204040078',
                        'descricao': 'RADIOGRAFIA DE COTOVELO',
                    },
                    {
                        'codigo': '0204040094',
                        'descricao': 'RADIOGRAFIA DE MAO',
                    },
                    {
                        'codigo': '0204040116',
                    ...
                    {
                        'codigo': '0204060109',
                        'descricao': 'RADIOGRAFIA DE CALCANEO',
                    },
                    {
                        'codigo': '0204060125',
            ...
            '0905010060': {
                ...
                'itens_obrigatorios': [
                    ...
                    {
                        'codigo': '0211060224',
                        'descricao': 'TESTE DE VISÃO DE CORES',
                    },
                    {'codigo': '0211060259', 'descricao': 'TONOMETRIA'},
                    {
                        'codigo': '0301010072',
    ...
    def analisar_csv(self, caminho_arquivo):
        ...
        df = df[
            df['STATUS'] == '1'
        ]  # Filtrar apenas registros com STATUS == 1
        ...
        for codigo, agrupamento in self.agrupamentos.items():
        ...
        for _, linha in pacientes_restantes.iterrows():
            descricao = next(
                (
                    item['descricao']
                    for g in self.agrupamentos.values()
